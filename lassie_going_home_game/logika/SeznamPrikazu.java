...
/**
 * Class SeznamPrikazu - eviduje seznam přípustných příkazů adventury. Používá se pro rozpoznávání
...
public class SeznamPrikazu {
  ...
  /**
   * Vrací odkaz na instanci třídy implementující rozhraní IPrikaz, která provádí příkaz uvedený
   * jako parametr.
   *
