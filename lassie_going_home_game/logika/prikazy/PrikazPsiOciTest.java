...
public class PrikazPsiOciTest {
  ...
  public void testPostavaOdtajnujeVychod() {
    ...
    // assert
    assertEquals(
        "Tvoje psí oči zabraly, postava pro test tě podrbe za uchem a pustí tě ven! Jsi v prostoru test popis.\n"
  ...
  public void testPostavaNakrmiPsaKdyzNemaObojek() {
    ...
    assertEquals(true, herniPlan.getAktualniProstor().getJeTamJidlo());
    assertEquals(
        "Bohužel nemáš obojek s adresou. postava pro test neví, co s tebou, dá ti svou svačinu a nechá tě být.",
        vysledek);
  }
}
