...
public class PrikazPsiOci implements IPrikaz {
    ...
    public String provedPrikaz(String... parametry) {
        ...
        if (plan.getAktualniProstor().getPostava().getSchopnosti().equals(Schopnosti.ODTAJNUJE_VYCHOD)) {
        ...
        } else if (plan.getAktualniProstor().getPostava().getSchopnosti().equals(Schopnosti.ZAVEZE_DO_CILE)) {
