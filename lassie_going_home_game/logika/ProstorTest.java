...
public class ProstorTest {
  ...
  /**
   * Testuje, zda jsou správně nastaveny průchody mezi prostory hry. Prostory nemusí odpovídat
   * vlastní hře,
   */
  @Test
  public void testLzeProjit() {
    Prostor prostor1 =
        new Prostor("kotec", "kotec, do kterého tě zavřel farmář.", false, false, false);
    Prostor prostor2 =
        new Prostor(
            "stáj",
            "stáj, ve které je miska s vodou, jídlo a tvůj starý obojek.",
            true,
            true,
            false);
